...
ST_STYLE = """
<style>
    /* --- 1. GLOBAL RESET (Force Light Mode Colors) --- */
    ...
    /* --- 2. INPUT FIELDS (Text Input, Text Area, Select Box Main View) --- */
    ...
    /* The main box of the select/multiselect */
    ...
    /* --- 3. DROPDOWN MENU FIX (The List that pops open) --- */
    /* This targets the floating container */
    div[data-baseweb="popover"] {
        background-color: #ffffff !important;
        border: 1px solid #ccc !important;
    }
    
    /* This targets the list inside the popover */
    ...
    /* CRITICAL: Force text inside options to be black */
    li[data-baseweb="option"] * {
        color: #000000 !important;
    }

    /* Hover & Selected States for Options (Green) */
